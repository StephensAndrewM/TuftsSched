...
var PERIODS = {
	...
	plus: {
		...
		'I+': [
			new SchedTime(0, 7.5, 75),
			new SchedTime(2, 7.5, 75)
		],
		'J+': [
	...
	numeric: {
		'0':  [ new SchedTime(0, 1,   150) ],
		'0+': [ new SchedTime(0, 0.5, 180) ],
		'1':  [ new SchedTime(1, 1,   150) ],
		'1+': [ new SchedTime(1, 0.5, 180) ],
		'2':  [ new SchedTime(2, 1,   150) ],
		'2+': [ new SchedTime(2, 0.5, 180) ],
		'3':  [ new SchedTime(3, 1,   150) ],
		'3+': [ new SchedTime(3, 0.5, 180) ],
		'4':  [ new SchedTime(4, 1,   150) ],
		'4+': [ new SchedTime(4, 0.5, 180) ],
		'5':  [ new SchedTime(0, 5.5, 150) ],
		'5+': [ new SchedTime(0, 5.5, 180) ],
		'6':  [ new SchedTime(1, 5.5, 150) ],
		'6+': [ new SchedTime(1, 5.5, 180) ],
		'7':  [ new SchedTime(2, 5.5, 150) ],
		'7+': [ new SchedTime(2, 5.5, 180) ],
		'8':  [ new SchedTime(3, 5.5, 150) ],
		'8+': [ new SchedTime(3, 5.5, 180) ],
		'9':  [ new SchedTime(4, 5.5, 150) ],
		'9+': [ new SchedTime(4, 5.5, 180) ],
		'10':  [ new SchedTime(0, 10.5, 150) ],
		'10+': [ new SchedTime(0, 10,   180) ],
		'11':  [ new SchedTime(1, 10.5, 150) ],
		'11+': [ new SchedTime(1, 10,   180) ],
		'12':  [ new SchedTime(2, 10.5, 150) ],
		'12+': [ new SchedTime(2, 10,   180) ],
		'13':  [ new SchedTime(3, 10.5, 150) ],
		'13+': [ new SchedTime(3, 10,   180) ]
	}
